...
class WordSearch2{
    ...
    public List<String> findWords(char[][] board, String[] words) {
        ...
        for(int i=0;i<m;i++){
            for(int j=0;j<n;j++){
                // unlike previous search problem where we had a single word to search,
                // here we cannot carry forward visited, as finding "oasis" and marking o and a as visited
                // will prevent us from finding "dance" if the a here is same as the a in "oasis"
                boolean[][] visited = new boolean[m][n];
